...
(function(){
  ...
  function refreshButtons(){
    ...
    $('#feTip').textContent = MODE==='db'
      ? '「저장하고 PDF」를 누르면 왼쪽 목록에 저장되고 인쇄 창이 떠요. 대상을 「PDF로 저장」으로 고르세요.' + PRINT_CLEAN_GUIDE + ' 원천세 신고·납부 뒤에는 원천징수이행상황신고서와 납부확인서를 챙겨 두세요.'
      : '미리보기 모드라 저장은 안 되고 PDF만 뽑혀요. 인쇄 창에서 「PDF로 저장」을 고르세요.' + PRINT_CLEAN_GUIDE + ' 원천세 신고·납부 뒤에는 원천징수이행상황신고서와 납부확인서를 챙겨 두세요.';
  }
