import {buildRoyalty,RANGES} from './model.mjs';
// 인세시트 읽기 전용. 인증은 scm-read와 같다. 구글 서비스 계정도 scm-read와 같은 비밀값(SCM_GOOGLE_SERVICE_ACCOUNT)을 쓴다.
// 시트 ID는 공개 저장소에 두지 않고 doc_settings(key='royalty_sheet_id', 관리자만 읽기)에서 요청한 사람 권한으로 읽는다.
